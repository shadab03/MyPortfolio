        ...
        <div className='grid w-full grid-cols-8 gap-16 pt-10'>
          <div className='col-span-3 flex flex-col items-start justify-start'>
            ...
            <p className='font-medium'>
              Hi, I&apos;m Shadab, a web developer and UI/UX designer with a passion for creating beautiful, functional, and user-centered digital experiences. With 4 years of experience in the field. I am always looking for new and innovative ways to bring my clients&apos; visions to life.
            </p>
